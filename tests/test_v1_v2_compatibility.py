...
ALLOWED_NEW_FILES = {
    ...
    # Unified three-mode product implementation (ADR-002). A presentation layer
    # over the existing live engine and the CLOSED V2 evidence: it adds typed
    # contracts, read-only serializers and one product shell. Nothing in this
    # set trains, tunes, evaluates a checkpoint, touches a holdout seed, or
    # writes under results/ or runs/ — tests/test_product_api.py asserts that
    # directly, and the two byte-identity tests below still protect V1's
    # models, results, figures, configs and simulation source.
    "mplssim/product/__init__.py",
    "mplssim/product/contracts.py",
    "mplssim/product/catalog.py",
    "mplssim/product/schemas.py",
    "mplssim/product/display_map.py",
    "mplssim/product/serialize.py",
    "mplssim/product/decision.py",
    "mplssim/product/timeline.py",
    "mplssim/product/counterfactual.py",
    "mplssim/product/fingerprint.py",
    "mplssim/product/pairing.py",
    "server/product_api.py",
    "frontend/app.html",
    "frontend/css/tokens.css",
    "frontend/css/shell.css",
    "frontend/css/topology-atlas.css",
    "frontend/css/presentation-mode.css",
    "frontend/css/network-mode.css",
    "frontend/css/rl-mode.css",
    "frontend/css/responsive.css",
    "frontend/js/product/contracts.js",
    "frontend/js/product/store.js",
    "frontend/js/product/router.js",
    "frontend/js/product/format.js",
    "frontend/js/product/dom.js",
    "frontend/js/product/adapters/live-v1.js",
    "frontend/js/product/adapters/recorded-v2.js",
    "frontend/js/product/adapters/evidence-v2.js",
    "frontend/js/product/shell.js",
    "frontend/js/product/provenance.js",
    "frontend/js/product/context-ledger.js",
    "frontend/js/product/topology-atlas.js",
    "frontend/js/product/topology-list.js",
    "frontend/js/product/explain.js",
    "frontend/js/product/help.js",
    "frontend/js/product/timeband.js",
    "frontend/js/product/modes/presentation.js",
    "frontend/js/product/modes/network.js",
    "frontend/js/product/modes/rl.js",
    "frontend/js/product/guided-story.js",
    "frontend/js/product/recommendation-card.js",
    "frontend/js/product/comparison-lane.js",
    "frontend/js/product/presenter-cockpit.js",
    "frontend/js/product/object-inspector.js",
    "frontend/js/product/demand-risk-table.js",
    "frontend/js/product/network-filters.js",
    "frontend/js/product/observation-inspector.js",
    "frontend/js/product/action-grid.js",
    "frontend/js/product/policy-outputs.js",
    "frontend/js/product/reward-waterfall.js",
...
ALLOWED_MODIFIED_FILES = {
    ...
    # Unified three-mode product implementation (ADR-002).
    "server/session.py",
    "frontend/index.html",
    "frontend/present.html",
    "frontend/study.html",
    "frontend/js/study.js",
    "mplssim/display.py",
